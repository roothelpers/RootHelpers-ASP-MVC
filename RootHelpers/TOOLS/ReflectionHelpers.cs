...
namespace RootHelpers.TOOLS
{
    ...
    public static class ReflectionHelpers
    {
        ...
        /// </summary>
        public static string EnumDisplayName(System.Type myEnum, Enum val)
        {
            var enumType = myEnum;
            if (!enumType.IsEnum)
            {
        ...
        /// Returns the Name value of Description attribute
        /// </summary>
        public static string EnumDescription(System.Type myEnum, Enum val)
        {
            var enumType = myEnum;
            if (!enumType.IsEnum)
            {
        ...
        /// Retuns Attribute
        /// </summary>
        internal static bool TryGetAttribute<T>(string name,System.Type modelType, out T attribute) where T : System.Attribute
        {
            ...
            if (property != null)
            {
                hasAttribute = System.Attribute.IsDefined(property, typeof(T));

                if (hasAttribute)
                {
                    attribute = (T)System.Attribute.GetCustomAttribute(property, typeof(T));
                }
            }
        ...
        /// Retuns Attribute
        /// </summary>
        internal static bool TryGetAttribute<T>(PropertyInfo property, out T attribute) where T : System.Attribute
        {
            var hasAttribute = false;
            attribute = default(T);
        ...
        /// </summary>
        internal static object GetModelStateValue(this HtmlHelper htmlHelper, string key, System.Type destinationType)
        {
        ...
        /// </summary>
        internal static string GetHtml5Type(this ControlType Type)
        {
        ...
        internal static string GetPropertyTypeName(System.Type propertyType)
        {
        ...
        /// </summary>
        internal static bool InheritsOrImplements(this System.Type child, System.Type parent)
        {
        ...
        private static bool HasAnyInterfaces(System.Type parent, System.Type child)
        {
        ...
        private static System.Type ResolveGenericTypeDefinition(System.Type parent)
        {
        ...
        internal static System.Type ResolveNullableType(this System.Type t)
        {
        ...
        internal static System.Type GetDeclaringType<T>(T instance, Expression<Func<T, object>> selector)
        {
