...
{
    public static class Culture2Helper
    {
        // Valid cultures
    ...
    public static class CultureHelper
    {
        ...
        public static MvcHtmlString Translate(this HtmlHelper htmlHelper, string key)
        {
            ...
            var name = viewPath.Split('/');
            var culture= RootHelpers.GENERAL.Tools.getlanguage();
            var FinalyName = name[name.Length - 1].Replace(".cshtml", "");
            var httpContext = htmlHelper.ViewContext.HttpContext;
            try
            {
                ResourceManager rm =
                     new ResourceManager("Resources."+ FinalyName,
                                         System.Reflection.Assembly.Load("App_GlobalResources"));
                CultureInfo ci = new CultureInfo(culture);
                var res = rm.GetString(key,ci);
